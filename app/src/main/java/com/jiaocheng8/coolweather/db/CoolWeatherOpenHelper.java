package com.jiaocheng8.coolweather.db;
...
public class CoolWeatherOpenHelper extends SQLiteOpenHelper
{
    ...
    //County表建表语句
    public static final String CREATE_COUNTY = "create table County(id integer primary key auto increment, county_name text,county_code text, city_id integer)";
